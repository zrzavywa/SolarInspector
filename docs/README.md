...
Diese Dokumentation beschreibt Installation, Konfiguration und Betrieb von Zrzavy Energy Monitor. Sie orientiert sich am Produktstand **4.5.5**.
...
- [Release Notes 4.5.5](release-notes-4.5.5.md)
