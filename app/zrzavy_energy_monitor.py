#!/usr/bin/env python3
"""Zrzavy Energy Monitor web application.
...
from zrzavy_energy_monitor_core.adapters.solakon import SolakonOneReader
...
from zrzavy_energy_monitor_core.config.manager import (
...
from zrzavy_energy_monitor_core.logging import log
from zrzavy_energy_monitor_core.models.legacy import (
    MeterPhaseReading as MeterPhaseReading,
)
from zrzavy_energy_monitor_core.models.legacy import MeterReading as MeterReading
...
from zrzavy_energy_monitor_core.persistence.startup import prepare_database_for_startup
from zrzavy_energy_monitor_core.runtime import (
    cleanup_runtime_pid_file,
    parse_runtime_args,
    run_application,
)
from zrzavy_energy_monitor_core.services.collector import Collector as CoreCollector
from zrzavy_energy_monitor_core.services.dashboard import (
    build_dashboard as _build_dashboard,
)
from zrzavy_energy_monitor_core.services.demo import generate_demo_samples
from zrzavy_energy_monitor_core.services.periods import (
...
from zrzavy_energy_monitor_core.services.update import (
...
from zrzavy_energy_monitor_core.web.context import build_template_context
from zrzavy_energy_monitor_core.web.export import (
    DEFAULT_MAXIMUM_EXPORT_ROWS,
    build_csv_export,
    build_time_series_csv_export,
)
from zrzavy_energy_monitor_core.web.pages import (
...
secret_key = resolve_known_environment_variable(SECRET_VARIABLE)
if not secret_key:
    raise RuntimeError(
        f"{SECRET_VARIABLE} ist nicht gesetzt. "
