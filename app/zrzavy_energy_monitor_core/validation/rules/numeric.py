...
from zrzavy_energy_monitor_core.models.units import Unit, unit_for_metric
from zrzavy_energy_monitor_core.validation.config import normalize_range_config
